...
// Program otelcol-clickhouse is an OpenTelemetry Collector binary.
package main
...
func main() {
	info := component.BuildInfo{
		Command:     "otelcol-clickhouse",
		Description: "OpenTelemetry custom collector, storage backend clickhouse",
		Version:     "v0.1.0",
	}
